...
#define NUM_MB_LINES 100
#define NUM_MB_COLUMNS 100
...
int main(int argc, char **argv) {
	...
	printf("Tempo de execução no modo serial: %.3f segundos\n", getTimeEnd(sequentialStartTime));
	...
	printf("Tempo de execução no modo paralelo: %.3f segundos\n", getTimeEnd(startTime));
	// FIM BUSCA PARALELA
